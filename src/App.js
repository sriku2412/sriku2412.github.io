    ...
    <div className="container">
      ...
      <section id="blog" className="blog">
        ...
        <ul>
          <li>
            <a
              href="https://medium.com/@sreekanthpotlabathini/clustering-multidimensional-time-series-sensor-data-a-friendly-walk-through-of-kl-js-emd-ks-07a7823043a1"
              target="_blank"
              rel="noreferrer"
            >
              Clustering Multidimensional Time-Series Data
            </a>{" "}
            – 5&nbsp;min read
          </li>
          <li>
            <a
              href="https://medium.com/@sreekanthpotlabathini/predicting-battery-life-a-practical-guide-with-production-ready-python-code-111a5102c187"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li>
            <a
              href="https://medium.com/@sreekanthpotlabathini/listening-to-machines-a-practical-guide-to-sound-based-anomaly-detection-with-lstm-6e7da45291f9"
              target="_blank"
              rel="noreferrer"
            >
              Sound-Based Anomaly Detection with LSTM
            </a>{" "}
            – 3&nbsp;min read
          </li>
          <li>
            <a
              href="https://medium.com/@sreekanthpotlabathini/from-thresholds-to-triumph-068dc229830f"
              target="_blank"
              rel="noreferrer"
            >
              Rule-Based Model Beat ML in Prod
            </a>{" "}
            – 4&nbsp;min read
          </li>
          <li>
            <a
              href="https://medium.com/@sreekanthpotlabathini/built-an-anomaly-detection-model-without-any-ground-truth-just-feedback-5034c80a2424"
              target="_blank"
              rel="noreferrer"
            >
              Anomaly Detection with Feedback Only
            </a>{" "}
            – 5&nbsp;min read
          </li>
        </ul>
      ...
      <footer className="footer">
        ...
        <p>
          <a href="mailto:srikanth.potlabathini@gmail.com">
            srikanth.potlabathini@gmail.com
          </a>
        </p>
      </footer>
    </div>
